...
const helpIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
        <g clip-path="url(#clip0_88906_55307)">
...
const searchIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        <g clip-path="url(#clip0_88906_55311)">
        ...
        <div className="flex md:flex-row flex-col px-8 py-3 md:items-center gap-4 border-b-[#D9D9D9] border-[1px] w-full">
            <div className="flex gap-4 items-center justify-start flex-1">
                ...
                <div className="text-[20px] font-medium text-[#1A181E]">
                    {
                        options?.map((option, index) => (
                            <p key={index} className="text-[20px] font-medium text-[#1A181E]">
                                {option?.path === pathname && option?.label}
                            </p>
                        ))
                    }
                </div>
                <p className="flex items-center gap-[6px]">
                    {helpIcon}
                    <span className="text-[#4D4D4D] text-[12px] font-normal">
                        How it works
                    </span>
                </p>
            </div>

            <div className="flex gap-2 items-center self-stretch w-[400px] shrink-0 bg-[#F2F2F2] rounded-[6px] px-[16px] py-[9px]">
                {searchIcon}
                <input
                    type="text"
                ...
                <div className="gap-3 flex items-start">
                    ...
                    <div className="w-[40px] h-[40px] shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                            <g clip-path="url(#clip0_88906_55322)">
